...
Section:Toggle("Aimbot", false, function(va)
    loadstring(game:HttpGet("https://pastebin.com/raw/vGcAZtua"))()
end)
...
local Section = Tab:Section("SelectWeapon")
local Weaponlist = {}
local Weapon = nil
...
Section:Dropdown("Weapon", tools, "Select!", function(currentOption)
	Weapon = currentOption
end)
Section:Toggle("Auto Equip", false, function(a)
    AutoEquiped = a
end)
